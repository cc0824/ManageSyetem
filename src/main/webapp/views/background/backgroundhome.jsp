...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				<li class="active"><a
					href="${pageContext.request.contextPath }/views/background/login.jsp">后台管理</a></li>
	...
	<div class="container ">
		...
		<table  border="0" align="center" >
			<tr >
				<td>
					<a href="${pageContext.request.contextPath}/user/EquipmentHouseKeeper.do" rel="external">
				...
				<td>
					<a href="${pageContext.request.contextPath}/user/MaunfacturingStatistics.do" rel="external">
			...
			<tr>
				...
				<td>
					<a href="${pageContext.request.contextPath}/views/personalInformation.jsp" rel="external">
