...
<!-- 				</div> -->
				<div class="form-group">
					<label for="inputType" class="col-xs-4 control-label" style="text-align: right">操作类型</label>
					<div class="col-xs-5">
						<select class="form-control" name="messageType">
							<option selected="selected" value="1">入库申请</option>
							<option value="2">出库申请</option>
						</select>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<a href="#" rel="external" id="myLink">
						<label for="inputProduct" class="col-xs-8 control-label" style="text-align: right">前往填写出入库商品</label>
					</a>
				</div>
				<div class="form-group">
